...
def test_lambda_handler_info_query(mock_table, lambda_context):
    mock_table.query.return_value = {
        "Items": [{"id": "1", "severity": "info", "datetime": "2024-01-01T00:00:00Z", "message": "Test log"}],
...
def test_lambda_handler_no_severity(mock_table, lambda_context):
    mock_table.query.return_value = {
        "Items": [{"id": "2", "severity": "warning", "datetime": "2024-01-02T00:00:00Z", "message": "Warning log"}],
        "LastEvaluatedKey": None,
    }
...
def test_lambda_handler_with_pagination(mock_table, lambda_context):
    mock_table.query.return_value = {
        "Items": [{"id": "3", "severity": "error", "datetime": "2024-01-03T00:00:00Z", "message": "Error log"}],
        "LastEvaluatedKey": {"severity": "error", "datetime": "2024-01-03T00:00:00Z", "id": "3"},
    }
